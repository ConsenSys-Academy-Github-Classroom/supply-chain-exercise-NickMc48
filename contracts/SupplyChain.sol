...
contract SupplyChain {
  ...
  modifier sold(uint _sku)
  {
    require(items[_sku].state == State.Sold,"Item is not marked as Sold!");
    _;
  }
  ...
  modifier shipped(uint _sku)
  {
    require(items[_sku].state == State.Shipped,"Item is not marked as Shipped!");
    _;
  }
  ...
  modifier received(uint _sku)
  {
    require(items[_sku].state == State.Received,"Item is not marked as Received!");
    _;
  }
